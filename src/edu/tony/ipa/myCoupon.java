...
public class myCoupon extends GDActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    final int ACTION_BAR_INFO = 0;//加上checkin button in action bar
    			...
    			tempBtn.setOnClickListener(new View.OnClickListener() {
    	             public void onClick(View v) {
    	            	...
    	            	// setActivityDetail(id);
    	            	 builder.setMessage("確定要使用此Coupon\n" + "序號 :" + String.valueOf(id)).setPositiveButton("是", new DialogInterface.OnClickListener() {
